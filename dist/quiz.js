...
const questionsDatabase = [
    ...
    },
    {
        ...
        answers: [{ id: 1, ans: "الفيل" }, { id: 2, ans: "حروشة" }, { id: 3, ans: "القط البرتقالي اللي براء رماة" }, { id: 4, ans: "الزرافة" }],
        correctAnswer: 4
    },
    {
        id: 13,
...
const resultPopupElement = document.querySelector('.answer-popup');
const resultScoreElement = resultPopupElement.querySelector('b');
const restartButton = resultPopupElement.querySelector('button');
class Quiz {
    constructor(time = 60) {
        this.quizTime = 60;
        this.originalTime = 0;
